  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.submitOperation = function(e) {
      ...
      if (error_free) {
		...
		var first = invocationUrl.indexOf("?");
		var last = invocationUrl.lastIndexOf("?");

		// Trata o bug do Swagger de colocar dois "?" na URL.
		if(first != last)
		{		
			invocationUrl = invocationUrl.substring(0, last) + "&" + invocationUrl.substring(last + 1, invocationUrl.length);
		}
